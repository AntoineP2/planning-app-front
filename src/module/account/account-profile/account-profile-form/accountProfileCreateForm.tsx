...
import { HourlyCaseEnum, PresenceEventType } from '~/module/calendar/calendarForm/calendarForm.utils';
import { useAccountProfileStore } from '../_store/accountProfile.store';

const AccountProfileCreateForm: React.FC = () => {
    ...
    const { modalState, setModalState, getProfilesList } = useAccountProfileStore()
    ...
    useEffect(() => {
        if(modalState === 'close' || modalState === 'create'){
            resetDataState()
        }
    }, [modalState, resetData, resetDataState])

    return (
        <div className="w-full relative py-2 max-md:mt-6">
            <div className='flex justify-center items-center'>
                <h1 className='text-2xl font-bold pb-5'>Créer un profil</h1>
            </div>
...
export default AccountProfileCreateForm;
