...
const CalendarCreateModal = () => {
    ...
    return (
        <div
            className={`fixed top-0 right-0 w-screen h-screen bg-white bg-opacity-80 flex justify-center items-center md:px-0 ${createEventModal ? 'scale-100' : 'scale-0'
                }`}
        >
            <div
                className={`relative  rounded-lg bg-blue-50 md:border-2 border-primary shadow-lg md:pb-5 w-[60%] max-md:h-screen max-md:w-screen md:min-w-[900px] transition duration-300 ${createEventModal ? 'scale-100' : 'scale-0'
                    }`}
            >
